...
{
    comac_surface_t *region, *similar;
    comac_t *cr_region, *cr_similar;
    ...
    /* copy the centre */
    cr_similar = comac_create (similar);
    comac_surface_destroy (similar);
    comac_set_source_surface (cr_similar, comac_get_target (cr), -20, -20);
    comac_paint (cr_similar);
    similar = comac_surface_reference (comac_get_target (cr_similar));
    comac_destroy (cr_similar);
    ...
    comac_set_source_surface (cr, similar, 20, 20);
...
COMAC_TEST (subsurface_modify_child,

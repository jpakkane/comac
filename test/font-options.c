...
preamble (comac_test_context_t *ctx)
{
    ...
    assert (comac_font_options_status (default_options) ==
    ...
    assert (comac_font_options_hash (default_options) ==
	    comac_font_options_hash (nil_options));
    assert (comac_font_options_hash (NULL) ==
	    comac_font_options_hash (nil_options));
    assert (comac_font_options_hash (default_options) ==
	    comac_font_options_hash (NULL));
    ...
    assert (comac_font_options_get_antialias (default_options) ==
    ...
    assert (comac_font_options_get_subpixel_order (default_options) ==
    ...
    assert (comac_font_options_get_hint_style (default_options) ==
    ...
    assert (comac_font_options_get_hint_metrics (default_options) ==
    ...
    assert (comac_font_options_get_color_palette (default_options) ==
    ...
    scaled_font = comac_scaled_font_create (comac_get_font_face (cr),
					    ...
					    &identity,
					    NULL);
    assert (comac_scaled_font_status (scaled_font) ==

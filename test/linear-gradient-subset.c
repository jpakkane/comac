...
draw_unit (comac_t *cr, double gradient_angle, double rotate_angle, int n_stops)
{
	...
	comac_pattern_add_color_stop_rgb (pattern, 0.8, 1.0, 1.0, 1.0);
    } else {
	comac_pattern_add_color_stop_rgb (pattern, 0.2, 1.0, 0.0, 0.0);
	comac_pattern_add_color_stop_rgb (pattern, 0.5, 1.0, 1.0, 1.0);
	comac_pattern_add_color_stop_rgb (pattern, 0.8, 0.0, 0.0, 1.0);
    }

...
#ifndef COMAC_SCALED_FONT_SUBSETS_PRIVATE_H
#define COMAC_SCALED_FONT_SUBSETS_PRIVATE_H
...
typedef struct _comac_scaled_font_subsets_glyph {
...
/**
 * _comac_scaled_font_subsets_create_scaled:
 *
 * Create a new #comac_scaled_font_subsets_t object which can be used
 * to create subsets of any number of #comac_scaled_font_t
 * objects. This allows the (arbitrarily large and sparse) glyph
 * indices of a #comac_scaled_font_t to be mapped to one or more font
 ...
 * _comac_scaled_font_subsets_destroy() when done with it.
 **/
comac_private comac_scaled_font_subsets_t *
_comac_scaled_font_subsets_create_scaled (void);

/**
 * _comac_scaled_font_subsets_create_simple:
 *
 * Create a new #comac_scaled_font_subsets_t object which can be used
 ...
 * separate font subsets for each #comac_scaled_font_t object.
 *
 ...
 **/
comac_private comac_scaled_font_subsets_t *
_comac_scaled_font_subsets_create_simple (void);

/**
 * _comac_scaled_font_subsets_create_composite:
 *
 * Create a new #comac_scaled_font_subsets_t object which can be used
 * to create font subsets suitable for embedding as Postscript or PDF
 * composite fonts.
 ...
 * each #comac_scaled_font_t object. Each unscaled subset has a maximum
 * of 256 glyphs.
 *
 ...
 **/
comac_private comac_scaled_font_subsets_t *
_comac_scaled_font_subsets_create_composite (void);

/**
 * _comac_scaled_font_subsets_destroy:
 * @font_subsets: a #comac_scaled_font_subsets_t object to be destroyed
 *
 * Destroys @font_subsets and all resources associated with it.
 **/
comac_private void
_comac_scaled_font_subsets_destroy (comac_scaled_font_subsets_t *font_subsets);

/**
 * _comac_scaled_font_subsets_enable_latin_subset:
 * @font_subsets: a #comac_scaled_font_subsets_t object to be destroyed
 * @use_latin: a #comac_bool_t indicating if a latin subset is to be used
 *
 ...
 * @font_subsets: a #comac_scaled_font_subsets_t
 ...
 *
 * Map a glyph from a #comac_scaled_font to a new index within a
 ...
 *    passed to _comac_scaled_font_subsets_create()) and that the
 *    resulting tuple is unique.
 *
 * 3) The smallest value of subset_glyph_index is returned such that
 *    the resulting tuple is unique.
 *
 * The net result is that any #comac_scaled_font_t will be represented
 ...
 * used by #comac_scaled_font_subset_t as provided by
 * _comac_scaled_font_subsets_foreach.
 *
 ...
 * unicode string.
 *
 * The returned values in the #comac_scaled_font_subsets_glyph_t struct are:
 *
 ...
 * @utf8_is_mapped: If true the utf8 string provided to _comac_scaled_font_subsets_map_glyph()
 ...
 *
 * Return value: %COMAC_STATUS_SUCCESS if successful, or a non-zero
 ...
 * _comac_scaled_font_subsets_map_glyph(). A subset is determined by
 * unique pairs of (font_id, subset_id) as returned by
 * _comac_scaled_font_subsets_map_glyph().
 *
 * For each subset, @font_subset_callback will be called and will be
 * provided with both a #comac_scaled_font_subset_t object containing
 * all the glyphs in the subset as well as the value of @closure.
 *
 * The #comac_scaled_font_subset_t object contains the scaled_font,
 ...
 * returned by _comac_scaled_font_subsets_map_glyph() while the
 ...
 *
 * Return value: %COMAC_STATUS_SUCCESS if successful,
 * %COMAC_INT_STATUS_UNSUPPORTED if the font backend does not support
...
/**
 * _comac_cff_subset_init:
 * @cff_subset: a #comac_cff_subset_t to initialize
 * @font_subset: the #comac_scaled_font_subset_t to initialize from
 *
 * If possible (depending on the format of the underlying
 * #comac_scaled_font_t and the font backend in use) generate a
 * cff file corresponding to @font_subset and initialize
 * @cff_subset with information about the subset and the cff
 * data.
 *
 * Return value: %COMAC_STATUS_SUCCESS if successful,
 * %COMAC_INT_STATUS_UNSUPPORTED if the font can't be subset as a
 ...
 * @cff_subset: a #comac_cff_subset_t
 *
 * Free all resources associated with @cff_subset.  After this
 * call, @cff_subset should not be used again without a
 * subsequent call to _comac_cff_subset_init() again first.
 **/
comac_private void
_comac_cff_subset_fini (comac_cff_subset_t *cff_subset);

/**
 * _comac_cff_scaled_font_is_cid_cff:
...
_comac_cff_scaled_font_is_cid_cff (comac_scaled_font_t *scaled_font);

/**
 * _comac_cff_fallback_init:
 * @cff_subset: a #comac_cff_subset_t to initialize
 * @font_subset: the #comac_scaled_font_subset_t to initialize from
 *
 * If possible (depending on the format of the underlying
 * #comac_scaled_font_t and the font backend in use) generate a cff
 ...
 **/
comac_private void
_comac_cff_fallback_fini (comac_cff_subset_t *cff_subset);

typedef struct _comac_truetype_subset {
    char *family_name_utf8;
    char *ps_name;
    double *widths;
    double x_min, y_min, x_max, y_max;
...
} comac_truetype_subset_t;

/**
 * _comac_truetype_subset_init_ps:
 * @truetype_subset: a #comac_truetype_subset_t to initialize
 * @font_subset: the #comac_scaled_font_subset_t to initialize from
 *
 * If possible (depending on the format of the underlying
 * #comac_scaled_font_t and the font backend in use) generate a
...
/**
 * _comac_truetype_subset_init_pdf:
 * @truetype_subset: a #comac_truetype_subset_t to initialize
 * @font_subset: the #comac_scaled_font_subset_t to initialize from
 *
 * If possible (depending on the format of the underlying
...
/**
 * _comac_truetype_subset_fini:
 * @truetype_subset: a #comac_truetype_subset_t
 *
 * Free all resources associated with @truetype_subset.  After this
 * call, @truetype_subset should not be used again without a
 * subsequent call to _comac_truetype_subset_init() again first.
 **/
comac_private void
_comac_truetype_subset_fini (comac_truetype_subset_t *truetype_subset);

comac_private const char *
_comac_ps_standard_encoding_to_glyphname (int glyph);

comac_private int
_comac_unicode_to_winansi (unsigned long unicode);

comac_private const char *
_comac_winansi_to_glyphname (int glyph);

typedef struct _comac_type1_subset {
    char *base_font;
    double *widths;
    double x_min, y_min, x_max, y_max;
    double ascent, descent;
 ...
 *
 * If possible (depending on the format of the underlying
 * #comac_scaled_font_t and the font backend in use) generate a type1
 * file corresponding to @font_subset and initialize @type1_subset
 * with information about the subset and the type1 data.
 *
 * Return value: %COMAC_STATUS_SUCCESS if successful,
 * %COMAC_INT_STATUS_UNSUPPORTED if the font can't be subset as a type1
 ...
 * @type1_subset: a #comac_type1_subset_t
 *
 ...
 * _comac_truetype_type1_init() again first.
 **/
comac_private void
_comac_type1_subset_fini (comac_type1_subset_t *subset);

/**
 * _comac_type1_scaled_font_is_type1:
 * @scaled_font: a #comac_scaled_font_t
 *
 ...
 **/
comac_private void
_comac_type1_fallback_fini (comac_type1_subset_t *subset);

typedef struct _comac_type2_charstrings {
    int *widths;
    long x_min, y_min, x_max, y_max;
    long ascent, descent;
    comac_array_t charstrings;
} comac_type2_charstrings_t;

/**
 * _comac_type2_charstrings_init:
 * @type2_subset: a #comac_type2_subset_t to initialize
 * @font_subset: the #comac_scaled_font_subset_t to initialize from
 *
 * If possible (depending on the format of the underlying
 * #comac_scaled_font_t and the font backend in use) generate type2
 * charstrings to @font_subset and initialize @type2_subset
 * with information about the subset.
 *
 * Return value: %COMAC_STATUS_SUCCESS if successful,
 * %COMAC_INT_STATUS_UNSUPPORTED if the font can't be subset as a type2
 ...
 * @subset: a #comac_type2_charstrings_t
 *
 ...
 * _comac_type2_charstring_init() again first.
 **/
comac_private void
_comac_type2_charstrings_fini (comac_type2_charstrings_t *charstrings);

/**
 * _comac_truetype_index_to_ucs4:
 * @scaled_font: the #comac_scaled_font_t
 * @index: the glyph index
 * @ucs4: return value for the unicode value of the glyph
 *
 * If possible (depending on the format of the underlying
 * #comac_scaled_font_t and the font backend in use) assign
 ...
 *
 * Return value: %COMAC_STATUS_SUCCESS if successful,
 * %COMAC_INT_STATUS_UNSUPPORTED if mapping glyph indices to unicode
 * is not supported.  Possible errors include %COMAC_STATUS_NO_MEMORY.
 **/
comac_private comac_int_status_t
 ...
 *
 * If possible (depending on the format of the underlying
 * #comac_scaled_font_t and the font backend in use) read the
 ...
 *
 * Return value: %COMAC_STATUS_SUCCESS if successful,
 * %COMAC_INT_STATUS_UNSUPPORTED if the font is not TrueType/OpenType
 ...
 * encode the byte.
 *
 * Return value: %COMAC_STATUS_SUCCESS if successful. Possible errors include
 * %COMAC_STATUS_NO_MEMORY.
 **/
comac_private comac_int_status_t
_comac_escape_ps_name (char **ps_name);
...
#endif /* COMAC_SCALED_FONT_SUBSETS_PRIVATE_H */

...
struct comac_compositor {
    ...
    comac_warn
	comac_int_status_t (*paint) (const comac_compositor_t *compositor,
				     comac_composite_rectangles_t *extents);

    comac_warn
	comac_int_status_t (*mask) (const comac_compositor_t *compositor,
				    comac_composite_rectangles_t *extents);

    comac_warn
	comac_int_status_t (*stroke) (const comac_compositor_t *compositor,
				      comac_composite_rectangles_t *extents,
    ...
    comac_warn
	comac_int_status_t (*fill) (const comac_compositor_t *compositor,
				    comac_composite_rectangles_t *extents,
				    const comac_path_fixed_t *path,
    ...
    comac_warn
	comac_int_status_t (*glyphs) (const comac_compositor_t *compositor,
				      comac_composite_rectangles_t *extents,
...
struct comac_mask_compositor {
    ...
    comac_int_status_t (*fill_rectangles) (void *surface,
					   comac_operator_t op,
    ...
    comac_int_status_t (*check_composite) (
	const comac_composite_rectangles_t *extents);

    comac_int_status_t (*composite) (void *dst,
				     comac_operator_t op,
				     comac_surface_t *src,
    ...
    comac_int_status_t (*check_composite_glyphs) (
	const comac_composite_rectangles_t *extents,
	comac_scaled_font_t *scaled_font,
	comac_glyph_t *glyphs,
	int *num_glyphs);
    comac_int_status_t (*composite_glyphs) (
	void *surface,
	comac_operator_t op,
	comac_surface_t *src,
	int src_x,
...
struct comac_traps_compositor {
    ...
    comac_int_status_t (*composite) (void *dst,
				     ...
				     unsigned int width,
				     unsigned int height);
    comac_int_status_t (*lerp) (void *_dst,
    ...
    comac_int_status_t (*composite_traps) (void *dst,
					   comac_operator_t op,
					   comac_surface_t *source,
					   int src_x,
					   int src_y,
    ...
    comac_int_status_t (*composite_tristrip) (
	void *dst,
	comac_operator_t op,
	comac_surface_t *source,
	int src_x,

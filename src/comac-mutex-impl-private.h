...
#define COMAC_MUTEX_IMPL_NOOP	do {/*no-op*/} while (0)
/* And one that evaluates its argument once */
#define COMAC_MUTEX_IMPL_NOOP1(expr)        do { (void)(expr); } while (0)
...
# define COMAC_MUTEX_IMPL_NIL_INITIALIZER { NULL, 0, 0, NULL, NULL, 0 }
...
# define COMAC_MUTEX_HAS_RECURSIVE_IMPL 1
# define COMAC_RECURSIVE_MUTEX_IMPL_INIT(mutex) do { \
...
# define COMAC_RECURSIVE_MUTEX_IMPL_NIL_INITIALIZER PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP

#else /**********************************************************************/

# error "XXX: No mutex implementation found.  Comac will not work with multiple threads.  Define COMAC_NO_MUTEX to 1 to acknowledge and accept this limitation and compile comac without thread-safety support."
...
# define COMAC_RECURSIVE_MUTEX_IMPL_NIL_INITIALIZER COMAC_MUTEX_IMPL_NIL_INITIALIZER

...
#define COMAC_FUNCTION_ALIAS(old, new)                                         \
    extern __typeof (new) old __asm__ ("" #old)                                \
...
#define _comac_add_size_t_overflow(a, b, c)                                    \
    __builtin_add_overflow ((size_t) (a), (size_t) (b), (size_t *) (c))
#define _comac_mul_size_t_overflow(a, b, c)                                    \
...
#include <intsafe.h>
#define _comac_add_size_t_overflow(a, b, c)                                    \
    (SizeTAdd ((size_t) (a), (size_t) (b), (size_t *) (c)) != S_OK)
#define _comac_mul_size_t_overflow(a, b, c)                                    \
    (SizeTMult ((size_t) (a), (size_t) (b), (size_t *) (c)) != S_OK)
#endif

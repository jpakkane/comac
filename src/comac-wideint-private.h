...
comac_uint64_t I	_comac_double_to_uint64 (double i);
double	       I	_comac_uint64_to_double (comac_uint64_t i);
comac_int64_t  I	_comac_double_to_int64 (double i);
double	       I	_comac_int64_to_double (comac_uint64_t i);

comac_uint64_t I	_comac_uint32_to_uint64 (uint32_t i);
#define			_comac_uint64_to_uint32(a)  ((a).lo)
comac_uint64_t I	_comac_uint64_add (comac_uint64_t a, comac_uint64_t b);
comac_uint64_t I	_comac_uint64_sub (comac_uint64_t a, comac_uint64_t b);
comac_uint64_t I	_comac_uint64_mul (comac_uint64_t a, comac_uint64_t b);
comac_uint64_t I	_comac_uint32x32_64_mul (uint32_t a, uint32_t b);
comac_uint64_t I	_comac_uint64_lsl (comac_uint64_t a, int shift);
comac_uint64_t I	_comac_uint64_rsl (comac_uint64_t a, int shift);
comac_uint64_t I	_comac_uint64_rsa (comac_uint64_t a, int shift);
int	       I	_comac_uint64_lt (comac_uint64_t a, comac_uint64_t b);
int	       I	_comac_uint64_cmp (comac_uint64_t a, comac_uint64_t b);
int	       I	_comac_uint64_eq (comac_uint64_t a, comac_uint64_t b);
comac_uint64_t I	_comac_uint64_negate (comac_uint64_t a);
#define			_comac_uint64_is_zero(a) ((a).hi == 0 && (a).lo == 0)
#define			_comac_uint64_negative(a)   (((int32_t) ((a).hi)) < 0)
comac_uint64_t I	_comac_uint64_not (comac_uint64_t a);

#define			_comac_uint64_to_int64(i)   (i)
#define			_comac_int64_to_uint64(i)   (i)

comac_int64_t  I	_comac_int32_to_int64(int32_t i);
...
comac_int64_t  I	_comac_int32x32_64_mul (int32_t a, int32_t b);
int	       I	_comac_int64_lt (comac_int64_t a, comac_int64_t b);
int	       I	_comac_int64_cmp (comac_int64_t a, comac_int64_t b);
 ...
 */
static comac_always_inline comac_const comac_uint64_t _comac_double_to_uint64 (double i) { return i; }
static comac_always_inline comac_const double _comac_uint64_to_double (comac_uint64_t i) { return i; }

static comac_always_inline comac_int64_t I _comac_double_to_int64 (double i) { return i; }
static comac_always_inline double I _comac_int64_to_double (comac_int64_t i) { return i; }
...
comac_uint128_t I	_comac_uint32_to_uint128 (uint32_t i);
comac_uint128_t I	_comac_uint64_to_uint128 (comac_uint64_t i);
#define			_comac_uint128_to_uint64(a)	((a).lo)
#define			_comac_uint128_to_uint32(a)	_comac_uint64_to_uint32(_comac_uint128_to_uint64(a))
comac_uint128_t I	_comac_uint128_add (comac_uint128_t a, comac_uint128_t b);
comac_uint128_t I	_comac_uint128_sub (comac_uint128_t a, comac_uint128_t b);
comac_uint128_t I	_comac_uint128_mul (comac_uint128_t a, comac_uint128_t b);
comac_uint128_t I	_comac_uint64x64_128_mul (comac_uint64_t a, comac_uint64_t b);
comac_uint128_t I	_comac_uint128_lsl (comac_uint128_t a, int shift);
comac_uint128_t I	_comac_uint128_rsl (comac_uint128_t a, int shift);
comac_uint128_t I	_comac_uint128_rsa (comac_uint128_t a, int shift);
int	        I	_comac_uint128_lt (comac_uint128_t a, comac_uint128_t b);
int	        I	_comac_uint128_cmp (comac_uint128_t a, comac_uint128_t b);
int	        I	_comac_uint128_eq (comac_uint128_t a, comac_uint128_t b);
#define			_comac_uint128_is_zero(a) (_comac_uint64_is_zero ((a).hi) && _comac_uint64_is_zero ((a).lo))
comac_uint128_t I	_comac_uint128_negate (comac_uint128_t a);
#define			_comac_uint128_negative(a)  (_comac_uint64_negative(a.hi))
comac_uint128_t I	_comac_uint128_not (comac_uint128_t a);

#define			_comac_uint128_to_int128(i)	(i)
#define			_comac_int128_to_uint128(i)	(i)

comac_int128_t  I	_comac_int32_to_int128 (int32_t i);
comac_int128_t  I	_comac_int64_to_int128 (comac_int64_t i);
#define			_comac_int128_to_int64(a)   ((comac_int64_t) (a).lo)
#define			_comac_int128_to_int32(a)   _comac_int64_to_int32(_comac_int128_to_int64(a))
...
comac_int128_t I _comac_int64x64_128_mul (comac_int64_t a, comac_int64_t b);
#define                 _comac_int64x32_128_mul(a, b) _comac_int64x64_128_mul(a, _comac_int32_to_int64(b))
...
int 	        I	_comac_int128_lt (comac_int128_t a, comac_int128_t b);
int	        I	_comac_int128_cmp (comac_int128_t a, comac_int128_t b);
...
comac_quorem64_t I
_comac_int_96by64_32x64_divrem (comac_int128_t num,
				comac_int64_t  den);

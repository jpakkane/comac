...
#error                                                                         \
    "COMAC_MUTEX_IMPL_TRY_LOCK not defined.  Check comac-mutex-impl-private.h."
#endif
...
#error                                                                         \
    "COMAC_MUTEX_IMPL_NIL_INITIALIZER not defined.  Check comac-mutex-impl-private.h."
#endif
#ifndef COMAC_RECURSIVE_MUTEX_IMPL_INIT
#error                                                                         \
    "COMAC_RECURSIVE_MUTEX_IMPL_INIT not defined.  Check comac-mutex-impl-private.h."
#endif
...
#define COMAC_MUTEX_IMPL_INITIALIZE()                                          \
    do {                                                                       \
...
#define COMAC_MUTEX_IMPL_INIT(mutex)                                           \
    do {                                                                       \
...
#define COMAC_MUTEX_IMPL_FINALIZE()                                            \
    do {                                                                       \
	if (_comac_mutex_initialized)                                          \
...
#define COMAC_RECURSIVE_MUTEX_NIL_INITIALIZER                                  \
    COMAC_RECURSIVE_MUTEX_IMPL_NIL_INITIALIZER

...
_comac_boilerplate_test_base_compositor_create_surface (const char		   *name,
...
{
    *closure = NULL;
    return _comac_test_base_compositor_surface_create (content, ceil (width), ceil (height));
}


static comac_surface_t *
_comac_boilerplate_test_fallback_compositor_create_surface (const char		   *name,
							    comac_content_t	    content,
							    double		    width,
							    double		    height,
							    double		    max_width,
...
{
    *closure = NULL;
    return _comac_test_fallback_compositor_surface_create (content, ceil (width), ceil (height));
}

static comac_surface_t *
_comac_boilerplate_test_mask_compositor_create_surface (const char		   *name,
							 comac_content_t	    content,
							 double			    width,
							 double			    height,
							 double			    max_width,
...
{
    *closure = NULL;
    return _comac_test_mask_compositor_surface_create (content, ceil (width), ceil (height));
}


static comac_surface_t *
_comac_boilerplate_test_traps_compositor_create_surface (const char		   *name,
							 comac_content_t	    content,
							 double			    width,
							 double			    height,
							 double			    max_width,
...
{
    *closure = NULL;
    return _comac_test_traps_compositor_surface_create (content, ceil (width), ceil (height));
}

static comac_surface_t *
_comac_boilerplate_test_spans_compositor_create_surface (const char		   *name,
							 comac_content_t	    content,
							 double			    width,
							 double			    height,
							 double			    max_width,
...
{
    *closure = NULL;
    return _comac_test_spans_compositor_surface_create (content, ceil (width), ceil (height));
}

static comac_surface_t *
_comac_boilerplate_test_no_fallback_compositor_create_surface (const char		   *name,
							       comac_content_t	    content,
							       double			    width,
							       double			    height,
							       double			    max_width,
							       ...
							       void			  **closure)
{
    ...
    *closure = NULL;
    return _comac_test_no_fallback_compositor_surface_create (content, ceil (width), ceil (height));
}

static comac_surface_t *
_comac_boilerplate_test_no_traps_compositor_create_surface (const char		   *name,
							 comac_content_t	    content,
							 double			    width,
							 double			    height,
							 double			    max_width,
							 ...
							 void			  **closure)
{
    ...
    *closure = NULL;
    return _comac_test_no_traps_compositor_surface_create (content, ceil (width), ceil (height));
}

static comac_surface_t *
_comac_boilerplate_test_no_spans_compositor_create_surface (const char		   *name,
							 comac_content_t	    content,
							 double			    width,
							 double			    height,
							 double			    max_width,
							 ...
							 void			  **closure)
{
    ...
    *closure = NULL;
    return _comac_test_no_spans_compositor_surface_create (content, ceil (width), ceil (height));
}
						  ...
						  void			   **closure)
{
    ...
    *closure = tpc = xmalloc (sizeof (test_paginated_closure_t));
    ...
    tpc->target = comac_image_surface_create (format,
...
_comac_boilerplate_test_paginated_surface_write_to_png (comac_surface_t *surface,
							const char	*filename)
{
    test_paginated_closure_t *tpc;
    comac_status_t status;
